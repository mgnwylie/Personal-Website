---
title: "Explore income inequality in Canadian cities: an interactive map of 2001- 2016 Gini coefficient data"
author: "Megan Wylie"
date: '2020-01-02'
categories: ["R"]
...
I completed Master's research in April of 2019 on the topic of income inequality and its impacts on health in Canadian cities. As part of this project I calculated income inequality in about 130 cities for 2001 through 2011. Once the 2016 census data was available, I also calculated updated income inequality. 

Now that data has been repurposed into an interactive leaflet map for your exploration! 
...
Cities in Canada generally range from low 0.3 score to higher 0.4. As a comparison to other countries, Boston had a Gini coefficient measure of .48 in 2015 and Oslo .31.

I calculated the income inequality bins by percentile. For each year of analysis, I binned the cities by lowest 25%, highest 25%, the 50th percentile, and the 75th percentile. 
